...
describe('GitHub Search', () => {
    ...
    it('should display search results for user "Rafael C. Pereira"', () => {
        ...
        cy.get('._userInfo_7hzna_67 > :nth-child(1)').should('have.text', 'Name: Rafael C. Pereira');
...
describe('Visit GitHub Website', () => {
    ...
    it('should search repositories', () => {
        ...
        cy.get('.color-border-muted')
            ...
            .find('[data-hydro-click-hmac="3983e3823cc84bca912d260ceb2a188efd3b831624281803687889b77957c7ec"]')
            .click();

        // Verify that search results for repositories are displayed
        cy.get('[data-hydro-click-hmac="3983e3823cc84bca912d260ceb2a188efd3b831624281803687889b77957c7ec"]').should('exist');

        // Click on a specific repository
        cy.get(':nth-child(2) > .col-10 > .d-inline-block.mb-1 > .wb-break-all > a').click();
        cy.get('#folder-row-4 > .react-directory-row-name-cell-large-screen > .react-directory-filename-column > .overflow-hidden > h3 > .react-directory-truncate > .Link--primary').click();
      
        // Verify the presence of text in a specific area
        cy.get('[data-testid="read-only-cursor-text-area"]').click().should('contain', 'lovelystay');
